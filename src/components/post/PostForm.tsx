        ...
        >
            <form>
                ...
                <input
                    ...
                    className="text-xs px-3 py-2 border border-gray-300 rounded-md w-full"
                />
                ...
                <div className="flex flex-row">
                    <Button color='secondary' size='xs' className="mt-4 mr-2"
                        onClick={() => setIsOpen(false)}>
                        Cancel
                    </Button>

                    <Button color='primary' size='xs' className="mt-4" 
                        onClick={submitPost}>
                        Create
                    </Button>
                </div>
